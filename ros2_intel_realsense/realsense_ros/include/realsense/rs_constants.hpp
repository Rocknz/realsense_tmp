...
const std::string DEFAULT_FISHEYE1_OPTICAL_FRAME_ID =
    "camera_fisheye1_optical_frame";
const std::string DEFAULT_FISHEYE2_OPTICAL_FRAME_ID =
...
const std::map<rs2_stream, std::string> MSG_ENCODING = {
...
const std::map<rs2_stream, rs2_format> STREAM_FORMAT = {
    {RS2_STREAM_COLOR, RS2_FORMAT_RGB8},
...
const std::map<rs2_stream, std::string> STREAM_NAME = {
    {RS2_STREAM_COLOR, "color"},    {RS2_STREAM_DEPTH, "depth"},
    {RS2_STREAM_INFRARED, "infra"}, {RS2_STREAM_ACCEL, "accel"},
    {RS2_STREAM_GYRO, "gyro"},      {RS2_STREAM_FISHEYE, "fisheye"},
    {RS2_STREAM_POSE, "pose"}};

const std::map<stream_index_pair, std::string> OPTICAL_FRAME_ID = {
    {COLOR, DEFAULT_COLOR_OPTICAL_FRAME_ID},
...
const std::map<stream_index_pair, std::string> SAMPLE_TOPIC = {
...
const std::map<stream_index_pair, std::string> INFO_TOPIC = {
